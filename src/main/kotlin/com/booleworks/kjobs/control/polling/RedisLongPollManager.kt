...
//
//class RedisLongPollManager(
//    protected val glideConfigBuilder: GlideClientConfiguration.GlideClientConfigurationBuilder<*, *>,
//    protected val channelName: String = DEFAULT_REDIS_CHANNEL
//) : LongPollManager {
//
//    // TODO separate clients
//    protected val publishClient = GlideClient.createClient(glideConfigBuilder.build()).get()
//    protected val listenerClient = GlideClient.createClient(
//        glideConfigBuilder.subscriptionConfiguration(
//            StandaloneSubscriptionConfiguration.builder()
//                .subscription(StandaloneSubscriptionConfiguration.PubSubChannelMode.EXACT, gs(channelName))
//                .callback { msg, _ -> println("Received '${msg.message}'") } // TODO remove
//                .build())
//            .build()).get()
//
...
//        logTime(log, Level.TRACE, { "Publishing in $it" }) { publishClient.publish(message, channelName) }
//    }
//
...
////        val subscribeConnection = redisClient.pubSubMessage.connectPubSub()
